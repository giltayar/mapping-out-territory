...
export default class Store {
  ...
  constructor(name, callback) {
     ...
     *
     * @returns {import('./item.js').ItemList} Current array of todos
     */
     ...
     *
     * @param {import('./item.js').ItemList} todos Array of todos to write
     */
   ...
   * @param {function(import('./item.js').ItemList)} callback Called when the query is done
   *
   * @example
   ...
   * @param {function(import('./item.js').ItemList)|function()} [callback] Called when records matching query are removed
   */
